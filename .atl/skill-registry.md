...
- C:\Users\Roger\.config\opencode\skills
- C:\Users\Roger\.claude\skills
- C:\Users\Roger\.gemini\skills
- C:\Users\Roger\.gemini\antigravity\skills
- C:\Users\Roger\.cursor\skills
- C:\Users\Roger\.copilot\skills
...
- Path: C:\Users\Roger\.gemini\antigravity\skills\accidental-data-loss-prevention\SKILL.md
- Trigger: |
- Rules:
...
- Path: C:\Users\Roger\.gemini\antigravity\skills\bigquery-data-transfer-service\SKILL.md
- Trigger: Discovers and inspects BigQuery Data Transfer Service (DTS) configurations.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### branch-pr
- Path: C:\Users\Roger\.config\opencode\skills\branch-pr\SKILL.md
...
### building-data-apps
- Path: C:\Users\Roger\.gemini\antigravity\skills\building-data-apps\SKILL.md
- Trigger: |
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### chained-pr
- Path: C:\Users\Roger\.config\opencode\skills\chained-pr\SKILL.md
...
- Path: C:\Users\Roger\.config\opencode\skills\cognitive-doc-design\SKILL.md
...
### comment-writer
- Path: C:\Users\Roger\.config\opencode\skills\comment-writer\SKILL.md
...
### data-autocleaning
- Path: C:\Users\Roger\.gemini\antigravity\skills\data-autocleaning\SKILL.md
- Trigger: Automated data quality and transformation capabilities for Dataform/dbt/BigQuery
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### dataform-bigquery
- Path: C:\Users\Roger\.gemini\antigravity\skills\dataform-bigquery\SKILL.md
- Trigger: Expertise in generating clean, correct, and efficient Dataform pipeline
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### dbt-bigquery
- Path: C:\Users\Roger\.gemini\antigravity\skills\dbt-bigquery\SKILL.md
- Trigger: Expert guidance for creating, modifying, and optimizing dbt pipelines
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### developing-with-bigquery
- Path: C:\Users\Roger\.gemini\antigravity\skills\developing-with-bigquery\SKILL.md
- Trigger: |
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### discovering-gcp-data-assets
- Path: C:\Users\Roger\.gemini\antigravity\skills\discovering-gcp-data-assets\SKILL.md
- Trigger: |
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### gcloud-auth-verification
- Path: C:\Users\Roger\.gemini\antigravity\skills\gcloud-auth-verification\SKILL.md
- Trigger: Guidelines for identifying and resolving missing Google Cloud authentication
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### gcp-composer-troubleshooting
- Path: C:\Users\Roger\.gemini\antigravity\skills\gcp-composer-troubleshooting\SKILL.md
- Trigger: Provides expert guidance for troubleshooting Cloud Composer (Apache
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### gcp-data-pipelines
- Path: C:\Users\Roger\.gemini\antigravity\skills\gcp-data-pipelines\SKILL.md
- Trigger: Primary entry point for building, managing, and orchestrating data pipelines
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### gcp-dataflow
- Path: C:\Users\Roger\.gemini\antigravity\skills\gcp-dataflow\SKILL.md
- Trigger: Provides guidance for writing, packaging and executing Apache Beam pipelines
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### gcp-pipeline-orchestration
- Path: C:\Users\Roger\.gemini\antigravity\skills\gcp-pipeline-orchestration\SKILL.md
- Trigger: This skill helps the agent generate or update orchestration pipeline
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### gcp-pipeline-resource-provisioning
- Path: C:\Users\Roger\.gemini\antigravity\skills\gcp-pipeline-resource-provisioning\SKILL.md
- Trigger: |
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### gcp-spark
- Path: C:\Users\Roger\.gemini\antigravity\skills\gcp-spark\SKILL.md
- Trigger: |
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### go-testing
- Path: C:\Users\Roger\.config\opencode\skills\go-testing\SKILL.md
...
### issue-creation
- Path: C:\Users\Roger\.config\opencode\skills\issue-creation\SKILL.md
...
### judgment-day
- Path: C:\Users\Roger\.config\opencode\skills\judgment-day\SKILL.md
...
- Path: C:\Users\Roger\.gemini\antigravity\skills\managing-python-dependencies\SKILL.md
- Trigger: |
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### ml-best-practices
- Path: C:\Users\Roger\.gemini\antigravity\skills\ml-best-practices\SKILL.md
- Trigger: |
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### notebook-guidance
- Path: C:\Users\Roger\.gemini\antigravity\skills\notebook-guidance\SKILL.md
- Trigger: |-
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### skill-creator
- Path: C:\Users\Roger\.config\opencode\skills\skill-creator\SKILL.md
...
### skill-repair
- Path: C:\Users\Roger\.gemini\antigravity\skills\skill-repair\SKILL.md
- Trigger: |
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### work-unit-commits
- Path: C:\Users\Roger\.config\opencode\skills\work-unit-commits\SKILL.md
